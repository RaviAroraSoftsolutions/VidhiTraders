...
import { getLogoDetails } from "../../../Redux/Auth/Action";
        ...
        <div className="mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center py-6">
              <img
                src={site?.logo||"https://res.cloudinary.com/ddkso1wxi/image/upload/v1675919455/Logo/Copy_of_Zosh_Academy_nblljp.png"}
                alt="Shopwithzosh"
